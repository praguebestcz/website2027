...
window.REFS = [
  ...
  /* ─── 1. El Nino ───────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'el nino parfum s.r.o.', b: 'Parfumerie · Retail' },
      rok:    { a: '2016 &ndash; 2026', b: '10 let spolupráce' },
      sluzby: { a: 'E-shop, BigData platforma, UpSearch', b: 'Virtual Try-On · Automatizace reklamací · Vyhledávač vůní' },
      stack:  { a: 'PHP · Elasticsearch · Redis', b: 'High Availability · Cache-First · API-Driven Frontend' }
    },
    initial: {
      heading: 'Platforma, která <span class="red">nestačila tempu růstu.</span>',
      lead: 'Elnino v&nbsp;roce 2016 stálo na&nbsp;startu ambiciózní mezinárodní expanze &ndash; a&nbsp;jejich tehdejší platforma jim v&nbsp;tom nestačila.',
      p1: 'Původní e-shop nedokázal uspokojivě zvládat rychlost, škálovatelnost ani komplexitu, kterou expanze do&nbsp;nových zemí přinášela. Každý nový trh přidával na&nbsp;tlaku: lokální ceníky, jazykové mutace, napojení na&nbsp;místní dopravce a&nbsp;platební metody.',
      p2: 'Firma zároveň věděla, že nechce stavět něco, co za&nbsp;pár let přeroste. Potřebovala robustní základ, který bude možné rozvíjet spolu s&nbsp;expanzí a&nbsp;novými výzvami &ndash; škálovatelný, výkonný bez&nbsp;kompromisů a&nbsp;připravený na&nbsp;to, co přijde. Naším úkolem bylo vytvořit platformu na&nbsp;míru, která toto vše splní a&nbsp;obstojí dlouhodobě.'
    },
    quote: {
      text: 'Praguebest pro nás představuje spolehlivého a&nbsp;zkušeného partnera, na&nbsp;kterého se&nbsp;můžeme dlouhodobě spolehnout a&nbsp;který dokáže flexibilně realizovat řešení přesně podle našich potřeb.',
      name: 'Ondřej Barnat',
      role: 'IT Ředitel · el nino parfum s.r.o. (2016&ndash;2025)'
    },
    pillars: [
  ...
  /* ─── 3. Hyundai ───────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Hyundai Motor Czech s.r.o.', b: 'Automotive · Dealerská síť' },
      rok:    { a: '2015', b: 'Vývoj a&nbsp;provoz' },
      sluzby: { a: 'Dealerské weby &ndash; design a&nbsp;vývoj', b: 'Design + vývoj + provoz' },
      stack:  { a: 'CMS Publisher', b: 'PHP · MySQL · REST API' }
    },
    initial: {
      heading: '60 dealerů, 60 různých webů. Jednotná značka, <span class="red">rozdílná nabídka vozů.</span>',
      lead: 'Dealerská síť Hyundai v&nbsp;České republice provozovala desítky webů na&nbsp;různých platformách, bez&nbsp;jednotného vizuálního stylu a&nbsp;sdílené funkcionality.',
      p1: 'Webové prezentace dealerů napříč republikou se&nbsp;od&nbsp;sebe výrazně lišily. Informace dostupné na&nbsp;jednom webu často chyběly na&nbsp;jiném, vyhledávání vozů fungovalo rozdílně &ndash; pokud bylo vůbec k&nbsp;dispozici &ndash; a&nbsp;vzhled jednotlivých prezentací mnohdy neodpovídal tomu, že všechna dealerství zastupují stejnou značku.',
      p2: 'Pro návštěvníky to znamenalo složité porovnávání nabídky vozů i&nbsp;ověřování aktuálních akčních nabídek. Zákaznická zkušenost se&nbsp;lišila dealer od&nbsp;dealera a&nbsp;orientace v&nbsp;dostupných informacích byla často zbytečně komplikovaná. Pro samotné dealery představovala správa vlastních webů dodatečné náklady na&nbsp;vývoj, provoz i&nbsp;průběžnou aktualizaci obsahu.',
      p3: 'Cílem projektu bylo sjednotit všechny dealerské prezentace pod&nbsp;jednu důvěryhodnou platformu a&nbsp;nabídnout zákazníkům konzistentní, přehledné a&nbsp;intuitivní prostředí. Současně bylo potřeba vybavit dealery nástroji, které zjednoduší správu obsahu a&nbsp;umožní snadnou integraci s&nbsp;externími systémy.'
    },
    pillars: [
  ...
  /* ─── 6. Konsepti ──────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Konsepti, spol. s&nbsp;r.o.', b: 'Luxusní nábytek · Interiérový design · E-commerce' },
      rok:    { a: '2020', b: 'Vývoj a&nbsp;provoz' },
      sluzby: { a: 'E-shop, design, vývoj', b: 'Design + vývoj + provoz' },
      stack:  { a: 'PHP 8.4 · MySQL', b: 'ERP Abra Gen · Comgate' }
    },
    initial: {
      heading: '30 let na trhu, stovky značek. Web, který to <span class="red">neukazoval.</span>',
      lead: 'Konsepti patří k&nbsp;nejvýznamnějším distributorům luxusního designového nábytku ve&nbsp;střední Evropě, ale digitální prezentace neodpovídala pozici značky ani rozsahu nabídky.',
      p1: 'Konsepti působí na trhu od&nbsp;roku 1995 a&nbsp;zaštiťuje zastoupení prémiových světových značek jako Vitra, B&amp;B Italia, Cassina, Flos, Moroso nebo Kartell v&nbsp;ČR a&nbsp;SR. Portfolio zahrnuje nábytek pro&nbsp;bydlení, kancelář, zahradu i&nbsp;svítidla a&nbsp;doplňky. Firma souběžně obsluhuje rezidenční klienty, architekty a&nbsp;velké B2B projekty &ndash; hotely, restaurace, firemní interiéry.',
      ...
      p3: 'Cílem bylo navrhnout a&nbsp;postavit nový e-shop hodný luxusních značek, které Konsepti zastupuje &ndash; s&nbsp;plynulou navigací, prémiovým designem, odděleným přístupem pro&nbsp;rezidenční klientelu, architekty i&nbsp;B2B, a&nbsp;vše ve&nbsp;třech jazykových mutacích.'
    },
    quote: {
      text: 'Krása a&nbsp;účelnost patří mezi podstatné hodnoty v&nbsp;životě. Odvaha vede k&nbsp;autentickému zážitku. Příběhy lidí a&nbsp;věcí přitahují. Plnit sny a&nbsp;překonávat očekávání klienta je náš základní úkol.',
      name: 'David Řezníček',
      role: 'Founder / CEO · Konsepti'
    },
    pillars: [
  ...
  /* ─── 7. Sparkys ───────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Sparkys', b: 'Maloobchod a&nbsp;velkoobchod · Hračky a&nbsp;potřeby pro děti' },
      rok:    { a: '2023', b: '5 měsíců vývoje' },
      sluzby: { a: 'Věrnostní program (Kačky), E-commerce integrace', b: 'Design + vývoj + provoz' },
      stack:  { a: 'PHP · MySQL', b: 'Moqups (wireframy)' }
    },
    initial: {
      heading: 'Zastaralé cenové hladiny vystřídal <span class="red">věrnostní program.</span>',
      lead: 'Klient potřeboval nahradit zastaralý systém fixních cenových hladin moderním věrnostním programem založeným na&nbsp;sběru a&nbsp;čerpání kreditů („Kaček"). Cílem bylo sjednotit zážitek mezi prodejnami a&nbsp;e-shopem při zajištění bezpečnosti transakcí.',
      p1: 'Před realizací projektu využíval Sparkys systém cenových hladin, který byl pro zákazníky méně přehledný a&nbsp;málo flexibilní. Na&nbsp;e-shopu chyběla hlubší integrace věrnostního klubu, která by umožňovala v&nbsp;reálném čase sledovat a&nbsp;uplatňovat nasbírané výhody přímo v&nbsp;košíku.',
      p2: 'Absence přímého propojení e-shopu s&nbsp;klubovým kontem v&nbsp;reálném čase vedla k&nbsp;riziku zneužití věrnostních bodů (např. vícenásobné čerpání stejného kreditu na&nbsp;prodejně i&nbsp;webu). Zákazníci neměli v&nbsp;uživatelské zóně dostatečný přehled o&nbsp;svých kartách a&nbsp;stavu konta, což snižovalo motivaci k&nbsp;opakovaným nákupům.',
      p3: 'Hlavním cílem bylo implementovat plně automatizovaný systém „Kaček", kde 1&nbsp;kačka odpovídá slevě 1&nbsp;Kč. Zadání zahrnovalo nové API rozhraní pro synchronizaci dat s&nbsp;Heliosem, štítkování produktů s&nbsp;odměnami a&nbsp;vývoj bezpečného procesu uplatnění slevy v&nbsp;košíku.'
    },
    quote: {
      text: 'Nahradit zastaralý systém cenových hladin moderním věrnostním programem byl klíčový krok. Výsledek předčil naše očekávání &ndash; zákazníci se&nbsp;vracejí.',
      name: 'Martin Koliandr',
      role: 'Manager E-commerce &amp; Online Marketingu · SPARKYS'
    },
    pillars: [
  ...
  /* ─── 8. Generali Penze ────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Generali', b: 'Finanční služby · Penzijní spoření' },
      rok:    { a: '2017', b: 'Vývoj a&nbsp;provoz' },
      sluzby: { a: 'Kalkulačky pro výpočet penze', b: 'Design + vývoj + provoz' },
      stack:  { a: 'CMS Publisher', b: 'PHP · MySQL · Sphinx' }
    },
    initial: {
      heading: 'Web, který nestačil ambicím jedné z&nbsp;<span class="red">největších penzijních společností.</span>',
      lead: 'Generali PS obsluhuje téměř 900&nbsp;000 klientů, ale digitální prezentace neodpovídala pozici lídra trhu s&nbsp;30letou historií.',
      p1: 'Generali penzijní společnost, součást skupiny Generali působící v&nbsp;ČR od&nbsp;roku 1994, patří k&nbsp;předním hráčům na&nbsp;trhu penzijního spoření s&nbsp;téměř 900&nbsp;000 klienty a&nbsp;sítí přes 900 prodejních míst. Stávající web ale neodpovídal ani rozsahu nabídky, ani očekáváním dnešních uživatelů &ndash; orientace v&nbsp;produktech byla složitá a&nbsp;cesta ke&nbsp;konverzi zbytečně dlouhá.',
      p2: 'Tři odlišné skupiny uživatelů &ndash; klienti, zaměstnavatelé a&nbsp;obchodní partneři &ndash; narážely na&nbsp;jednotný web, který nebyl přizpůsobený jejich potřebám. Kalkulačky a&nbsp;produktové stránky nepodporovaly rozhodovací proces a&nbsp;nenavazovaly přirozeně na&nbsp;sjednání smlouvy.',
      p3: 'Naším cílem bylo postavit přehledný, rychlý a&nbsp;konverzně optimalizovaný web &ndash; jasně strukturovaný pro každou skupinu návštěvníků, s&nbsp;výkonnými kalkulačkami a&nbsp;přirozenou návazností na&nbsp;obchodní procesy.'
    },
    quote: {
      text: 'Chceme být vždy o&nbsp;krok před konkurencí &ndash; a&nbsp;digitální kanály jsou dnes tím nejdůležitějším místem, kde každý klient začíná svůj vztah s&nbsp;námi.',
      name: 'Jana Zelinková',
      role: 'Generální ředitelka · Generali penzijní společnost'
    },
    pillars: [
  ...
  /* ─── 9. DPP ───────────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Dopravní podnik hl. m. Prahy', b: 'Veřejná doprava' },
      rok:    { a: '2019', b: 'Vývoj a&nbsp;provoz' },
      sluzby: { a: 'Web, design, vývoj', b: 'Vývoj + provoz' },
      stack:  { a: 'PHP · Elasticsearch', b: 'Golemio API · MySQL' }
    },
    initial: {
      heading: 'Přes milion cestujících denně. A&nbsp;web, který musí <span class="red">odpovědět každému.</span>',
      lead: 'Web DPP je první místo, kam Pražané míří pro výluky, jízdenky i&nbsp;aktuální odjezdy &ndash; musí unést obrovskou šíři agend i&nbsp;špičky provozu.',
      p1: 'Dopravní podnik hl. m. Prahy je největší městský dopravce v&nbsp;ČR &ndash; provozuje metro, tramvaje i&nbsp;autobusy a&nbsp;denně přepraví nespočet cestujících. Jeho web není vizitka, ale provozní nástroj: cestující na&nbsp;něm hledají spojení, výluky, tarify i&nbsp;prodejní místa a&nbsp;očekávají odpověď okamžitě.',
      p2: 'Šíře agend je přitom enormní &ndash; od&nbsp;jízdních řádů a&nbsp;tarifních zón přes mimořádnosti v&nbsp;provozu až po muzeum vozidel, školní programy nebo bezbariérový přístup do&nbsp;metra.',
      p3: 'Cílem bylo postavit platformu, která tuto šíři unese: živá data o&nbsp;provozu přímo na&nbsp;webu, výkonné vyhledávání nad&nbsp;celým obsahem a&nbsp;desítky samostatných agend spravovaných z&nbsp;jednoho systému.'
    },
    pillars: [
  ...
  /* ─── 10. Bambule ───────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Alltoys', b: 'Hračky a&nbsp;volný čas' },
      rok:    { a: '2022', b: '4 měsíce vývoje' },
      sluzby: { a: 'Rezervační systém z&nbsp;webu na&nbsp;prodejny', b: 'Design + vývoj + provoz' },
      stack:  { a: 'PHP · MySQL', b: 'AJAX · Cron · cachování dat' }
    },
    initial: {
      heading: 'Rezervace na&nbsp;prodejnu, která <span class="red">nebrzdí web.</span>',
      lead: 'Klient potřeboval sjednotit a&nbsp;zjednodušit proces online rezervací zboží na&nbsp;svých kamenných pobočkách tak, aby odpovídal standardům velkých hráčů na&nbsp;trhu.',
      p1: 'Před zahájením projektu využívaly e-shop Bambule standardní proces vložení do&nbsp;košíku, který nebyl optimalizován pro rychlou rezervaci na&nbsp;prodejně. Zákazník neměl jasnou informaci o&nbsp;tom, na&nbsp;kolika a&nbsp;na&nbsp;kterých prodejnách je zboží ihned k&nbsp;dispozici přímo ve&nbsp;výpisu nebo detailu produktu.',
      p2: 'Absence přímé cesty k&nbsp;rezervaci nutila zákazníky procházet standardním více-krokovým košíkem, což mohlo vést k&nbsp;opouštění procesu. Provoz webu mohl být ohrožen, pokud by se&nbsp;skladová dostupnost na&nbsp;desítkách prodejen počítala v&nbsp;reálném čase při každém načtení stránky.',
      p3: 'Hlavním cílem bylo vytvořit nový nákupní rozcestník, který umožní volbu mezi klasickým nákupem a&nbsp;okamžitou rezervací, zajistit plynulý průchod zjednodušeným košíkem a&nbsp;udržet vysoký výkon e-shopu i&nbsp;při vysoké zátěži (např. Black Friday).'
    },
    pillars: [
  ...
  /* ─── 11. Armed ────────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Armed', b: 'Maloobchod s&nbsp;army a&nbsp;outdoor vybavením' },
      rok:    { a: '2023&ndash;2024', b: '6 měsíců vývoje' },
      sluzby: { a: 'Vývoj webového pokladního systému (Webkasa), integrace ERP', b: 'Design + vývoj + provoz' },
      stack:  { a: 'PHP · JavaScript', b: 'ERP Vario · GP Tom' }
    },
    initial: {
      heading: 'Pokladna, která <span class="red">nesmí spadnout.</span>',
      lead: 'Klient potřeboval sjednotit prodej na&nbsp;pobočkách s&nbsp;e-shopovým rozhraním a&nbsp;zajistit plnou automatizaci datových toků do&nbsp;podnikového systému Vario.',
      p1: 'Před implementací Webkasy nebyl prodej na&nbsp;prodejnách plně integrován do&nbsp;digitálního ekosystému e-shopu. Obsluha používala proprietární POS systém v&nbsp;ERP Vario, který trpěl výpadky a&nbsp;zdržoval jak zákazníky, tak prodavače.',
      p2: 'Tento stav měl negativní dopad na&nbsp;rychlost odbavení zákazníků, zejména ve&nbsp;špičkách.',
      p3: 'Naším cílem bylo vytvořit modulární webové rozhraní (Webkasu) jako primární nástroj pro pokladníky &ndash; bleskové markování zboží, automatizovaná registrace zákazníků včetně profesních slev a&nbsp;okamžitý tisk účtenek přímo z&nbsp;e-shopového prostředí.'
    },
    quote: {
      text: 'Cílem bylo vytvořit jednodušší a&nbsp;na&nbsp;zákazníka zaměřený systém, který funguje spolehlivě a&nbsp;integruje marketingové funkce e-shopu.',
      name: 'Pavel Zendulka',
      role: 'Jednatel · Armed'
    },
    pillars: [
  ...
  /* ─── 12. Terezia ──────────────────────────────────── */
  {
    ...
    href:     'terezia.html',
    domain:   'terezia.eu',
    badge:    { show: false, text: 'WT100', year: '' },
    cat:      'E-commerce · D2C · EU',
    meta: {
      klient: { a: 'The Terezia Company, s.r.o.', b: 'Doplňky stravy · E-commerce' },
      rok:    { a: '', b: '' },
      sluzby: { a: 'E-shop, design, vývoj', b: 'Design + vývoj + provoz' },
      stack:  { a: 'PHP · MySQL', b: 'GPwebpay · PayU · PayPal' }
    },
    initial: {
      heading: 'Třicet let výzkumu a&nbsp;výroby. Web, který to <span class="red">nedokázal předat.</span>',
      lead: 'Terezia Company je česká rodinná firma s&nbsp;vlastní výrobou, klinickými studiemi a&nbsp;distribucí do&nbsp;celé EU &ndash; digitální prodejní kanál ale neodpovídal šíři a&nbsp;důvěryhodnosti značky.',
      p1: 'The Terezia Company působí od&nbsp;roku 1990 a&nbsp;jako první v&nbsp;ČR uvedla v&nbsp;roce 2004 hlívu ústřičnou na&nbsp;trh v&nbsp;kapslích jako potravinový doplněk. Dnes má v&nbsp;portfoliu přes 50 produktů z&nbsp;léčivých hub a&nbsp;rostlin, vlastní certifikovanou výrobní linku a&nbsp;řadu klinických studií.',
      p2: 'Mezinárodní distribuce vyžadovala e-shop schopný obsluhovat zákazníky v&nbsp;různých zemích &ndash; v&nbsp;jejich jazyce, s&nbsp;lokální dopravou a&nbsp;platebními možnostmi. Zároveň bylo klíčové předat důvěryhodnost značky: vlastní výroba, certifikace HACCP, dohled SZPI a&nbsp;laboratorní analýzy každé šarže.',
      p3: 'Cílem bylo postavit přehledný vícejazyčný e-shop, který zákazníkovi pomůže vybrat správný produkt, podpoří důvěru v&nbsp;kvalitu a&nbsp;zvládne provoz na&nbsp;více trzích s&nbsp;různými dopravci a&nbsp;platebními metodami.'
    },
    pillars: [
  ...
  /* ─── 13. Travel Free ──────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Travel Free', b: 'Duty-free · Travel retail' },
      rok:    { a: '2016', b: 'Vývoj a&nbsp;provoz' },
      sluzby: { a: 'Web design a&nbsp;vývoj, API pro mobilní aplikaci', b: 'Design + vývoj + provoz' },
      stack:  { a: 'PHP · Elasticsearch', b: 'MS Dynamics NAV · Firebase' }
    },
    initial: {
      heading: '27 prodejen, dvě měny, dva jazyky. A&nbsp;ERP, který to <span class="red">drží pohromadě.</span>',
      lead: 'Travel FREE provozuje 27 prodejen podél celé české hranice a&nbsp;potřeboval jednotnou digitální platformu napojenou na&nbsp;ERP &ndash; která zákazníkovi ukáže aktuální nabídku a&nbsp;věrnostní program v&nbsp;reálném čase.',
      p1: 'Travel FREE je součástí mezinárodní skupiny Gebr. Heinemann a&nbsp;jako Europe\'s No.&nbsp;1 Bordershop provozuje 27 prodejen od&nbsp;Aše přes Rozvadov až po Mikulov a&nbsp;Hevlín. Sortiment zahrnuje prémiové lihoviny, kávu, cukrovinky, parfémy a&nbsp;exkluzivní border-only edice.',
      p2: 'Travel retail má jedno zásadní omezení: online prodej a&nbsp;doručení není ze&nbsp;zákonných důvodů možné. Web proto nesměl být e-shopem &ndash; ale musel fungovat jako důvěryhodný digitální průvodce, který zákazníka připraví na&nbsp;návštěvu prodejny, ukáže ceny a&nbsp;akce a&nbsp;umožní rezervaci vybraných produktů.',
      p3: 'K&nbsp;tomu přibyla potřeba obsluhovat dvě jazykové skupiny (CZ/DE) ve&nbsp;dvou měnách a&nbsp;propojit web s&nbsp;mobilní aplikací a&nbsp;věrnostním programem CLUBCARD &ndash; to vše napojeno na&nbsp;jediný zdroj dat: ERP Microsoft Dynamics NAV.'
    },
    pillars: [
  ...
  /* ─── 14. Kinoko ───────────────────────────────────── */
  {
    ...
    meta: {
      klient: { a: 'Kinoko', b: 'Sportovní oblečení · Móda · D2C' },
      rok:    { a: '2022', b: 'Vývoj a&nbsp;provoz' },
      sluzby: { a: 'E-shop, vývoj', b: 'Design + vývoj + provoz' },
      stack:  { a: 'PHP 8.3 · MySQL', b: 'ERP AlbiLine · Sphinx' }
    },
    initial: {
      heading: 'E-shop je jen tak dobrý, jak <span class="red">čerstvá jsou jeho data.</span>',
      lead: 'Kinoko je česká značka prémiového sportovního oblečení pro ženy, která od&nbsp;svého vzniku v&nbsp;roce 2020 rychle roste &ndash; a&nbsp;její e-shop musel růst s&nbsp;ní.',
      p1: 'Kinoko založil v&nbsp;roce 2020 Antonín Kokeš, zakladatel Albi, s&nbsp;cílem vytvořit co nejpohodlnější sportovní oblečení pro ženy všech postav. Od&nbsp;roku 2021 značka šije v&nbsp;České republice. Sortiment zahrnuje legíny, sportovní podprsenky, šortky, mikiny i&nbsp;jógamatky &ndash; výhradně pro ženy, ve&nbsp;střizích pro různé proporce.',
      p2: 'Pro fungování D2C značky s&nbsp;vlastní výrobou a&nbsp;lokálním ERP byl klíčový spolehlivý tok dat mezi skladem a&nbsp;e-shopem. Zákaznice potřebovaly vidět přesnou dostupnost velikostí v&nbsp;reálném čase, včetně předobjednávek na&nbsp;zboží na&nbsp;cestě. Současně bylo nutné zajistit spolehlivé měření i&nbsp;v&nbsp;prostředí s&nbsp;vysokým podílem blokátorů reklam.',
      p3: 'Zadání zahrnovalo e-shop s&nbsp;integrací na&nbsp;ERP AlbiLine, fulltextové vyhledávání s&nbsp;našeptávačem, server-side měření přes GA4 Measurement Protocol a&nbsp;XML feedy pro cenové srovnávače.'
    },
    pillars: [
